...
class MapsdriverFragment : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mapsdriver)
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent): Boolean {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            builder.setMessage("¿Desea Cerrar Sesion?").setPositiveButton("Si", DialogInterface.OnClickListener { dialog, which ->
                val intent = Intent(this@MapsdriverFragment, inicio::class.java)
